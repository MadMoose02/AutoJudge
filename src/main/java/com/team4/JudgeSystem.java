...
public class JudgeSystem implements AutoJudgeInterface {
     ...
     */
    public JudgeSystem(String zippedSubmissionsFilename) {
     ...
     * @param zippedSubmissionsFilename Name of the zipped submissions file
     */
    public JudgeSystem(String resourcesPath, String zippedSubmissionsFilename) {
    ...
    public void evaluateSubmissions() {
        ...
        this.overallScore = this.evaluator.runEvaluators(this.submissions);
